...
import de.fraunhofer.fokus.oefit.particity.service.AHOfferLocalService;
...
/**
 * Provides the base implementation for the a h offer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.fraunhofer.fokus.oefit.particity.service.impl.AHOfferLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class AHOfferLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AHOfferLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.fraunhofer.fokus.oefit.particity.service.AHOfferLocalServiceUtil} to access the a h offer local service.
	 */
	...
	@Override
	public AHOffer addAHOffer(AHOffer ahOffer) {
		ahOffer.setNew(true);

		return ahOfferPersistence.update(ahOffer);
	}
	 ...
	 */
	@Override
	public AHOffer createAHOffer(long offerId) {
		return ahOfferPersistence.create(offerId);
	}
	...
	@Override
	public AHOffer deleteAHOffer(long offerId) throws PortalException {
		return ahOfferPersistence.remove(offerId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AHOffer deleteAHOffer(AHOffer ahOffer) {
		return ahOfferPersistence.remove(ahOffer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AHOffer.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ahOfferPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ahOfferPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return ahOfferPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ahOfferPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return ahOfferPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public AHOffer fetchAHOffer(long offerId) {
		return ahOfferPersistence.fetchByPrimaryKey(offerId);
	}
	 ...
	 */
	@Override
	public AHOffer getAHOffer(long offerId) throws PortalException {
		return ahOfferPersistence.findByPrimaryKey(offerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ahOfferLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AHOffer.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ahOfferLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AHOffer.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ahOfferLocalService.deleteAHOffer((AHOffer)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ahOfferPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AHOffer> getAHOffers(int start, int end) {
		return ahOfferPersistence.findAll(start, end);
	}
	...
	public int getAHOffersCount() {
		return ahOfferPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AHOffer updateAHOffer(AHOffer ahOffer) {
		return ahOfferPersistence.update(ahOffer);
	}
	...
	public void addAHCatEntriesAHOffer(long itemId, long offerId) {
		ahCatEntriesPersistence.addAHOffer(itemId, offerId);
	}

	/**
	 */
	@Override
	public void addAHCatEntriesAHOffer(long itemId, AHOffer ahOffer) {
		ahCatEntriesPersistence.addAHOffer(itemId, ahOffer);
	}
	...
	public void addAHCatEntriesAHOffers(long itemId, long[] offerIds) {
		ahCatEntriesPersistence.addAHOffers(itemId, offerIds);
	}

	/**
	 */
	@Override
	public void addAHCatEntriesAHOffers(long itemId, List<AHOffer> ahOffers) {
		ahCatEntriesPersistence.addAHOffers(itemId, ahOffers);
	}
	...
	public void clearAHCatEntriesAHOffers(long itemId) {
		ahCatEntriesPersistence.clearAHOffers(itemId);
	}
	...
	public void deleteAHCatEntriesAHOffer(long itemId, long offerId) {
		ahCatEntriesPersistence.removeAHOffer(itemId, offerId);
	}

	/**
	 */
	@Override
	public void deleteAHCatEntriesAHOffer(long itemId, AHOffer ahOffer) {
		ahCatEntriesPersistence.removeAHOffer(itemId, ahOffer);
	}
	...
	public void deleteAHCatEntriesAHOffers(long itemId, long[] offerIds) {
		ahCatEntriesPersistence.removeAHOffers(itemId, offerIds);
	}

	/**
	 */
	@Override
	public void deleteAHCatEntriesAHOffers(long itemId, List<AHOffer> ahOffers) {
		ahCatEntriesPersistence.removeAHOffers(itemId, ahOffers);
	}

	/**
	 * Returns the itemIds of the a h cat entrieses associated with the a h offer.
	 *
	 * @param offerId the offerId of the a h offer
	 * @return long[] the itemIds of a h cat entrieses associated with the a h offer
	 */
	@Override
	public long[] getAHCatEntriesPrimaryKeys(long offerId) {
		return ahOfferPersistence.getAHCatEntriesPrimaryKeys(offerId);
	}

	/**
	 */
	@Override
	public List<AHOffer> getAHCatEntriesAHOffers(long itemId) {
		return ahCatEntriesPersistence.getAHOffers(itemId);
	}

	/**
	 */
	@Override
	public List<AHOffer> getAHCatEntriesAHOffers(long itemId, int start, int end) {
		return ahCatEntriesPersistence.getAHOffers(itemId, start, end);
	}

	/**
	 */
	@Override
	public List<AHOffer> getAHCatEntriesAHOffers(long itemId, int start,
		int end, OrderByComparator<AHOffer> orderByComparator) {
		return ahCatEntriesPersistence.getAHOffers(itemId, start, end,
			orderByComparator);
	}
	...
	public int getAHCatEntriesAHOffersCount(long itemId) {
		return ahCatEntriesPersistence.getAHOffersSize(itemId);
	}
	...
	public boolean hasAHCatEntriesAHOffer(long itemId, long offerId) {
		return ahCatEntriesPersistence.containsAHOffer(itemId, offerId);
	}
	...
	public boolean hasAHCatEntriesAHOffers(long itemId) {
		return ahCatEntriesPersistence.containsAHOffers(itemId);
	}
	...
	public void setAHCatEntriesAHOffers(long itemId, long[] offerIds) {
		ahCatEntriesPersistence.setAHOffers(itemId, offerIds);
	}
	 ...
	 */
	public AHOfferLocalService getAHOfferLocalService() {
	 ...
	 */
	public void setAHOfferLocalService(AHOfferLocalService ahOfferLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("de.fraunhofer.fokus.oefit.particity.model.AHOffer",
			ahOfferLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AHOfferLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ahOfferPersistence.getDataSource();
	...
	@BeanReference(type = AHOfferLocalService.class)
	protected AHOfferLocalService ahOfferLocalService;
