...
public abstract class AHConfigLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AHConfigLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	@Override
	public AHConfig addAHConfig(AHConfig ahConfig) {
	...
	@Override
	public AHConfig deleteAHConfig(String name) throws PortalException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AHConfig deleteAHConfig(AHConfig ahConfig) {
	...
	@Override
	public AHConfig fetchAHConfig(String name) {
	 ...
	 */
	@Override
	public AHConfig getAHConfig(String name) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ahConfigLocalService.deleteAHConfig((AHConfig)persistedModel);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AHConfig updateAHConfig(AHConfig ahConfig) {
		return ahConfigPersistence.update(ahConfig);
	}
	 ...
	 */
	public AHConfigLocalService getAHConfigLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("de.fraunhofer.fokus.oefit.particity.model.AHConfig",
	...
	public String getOSGiServiceIdentifier() {
		return AHConfigLocalService.class.getName();
	}
	...
	@BeanReference(type = AHConfigLocalService.class)
	protected AHConfigLocalService ahConfigLocalService;
