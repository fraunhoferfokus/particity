...
<div class="container-fluid">
  ...
  <!-- if demo-mode enabled, notify about denied actions -->
    ...
    <% if (errorCode != null && errorCode.trim().length() > 0) { 
        String emsg = LanguageUtil.get(locale,errorCode);
    %>
       ...
       <% } 
          if (exportLogs != null) {
        	  ...
        	  for (String name : exportLogs.keySet()) {
        		  ...
        		  if (value.length() > 0) {
        			  String msg = LanguageUtil.get(locale,"admin.tab.db.export.log."+name.toLowerCase().trim());
	        		  %>
       ...
       <%
        if (importLogs != null) {
           ...
           for (String name : importLogs.keySet()) {
             ...
             if (value.length() > 0) {
               String msg = LanguageUtil.get(locale,"admin.tab.db.import.log."+name.toLowerCase().trim());
               %>
                 <strong><%= msg %></strong>:<br/>
                 <%= value %><br/><br/>
               <%
