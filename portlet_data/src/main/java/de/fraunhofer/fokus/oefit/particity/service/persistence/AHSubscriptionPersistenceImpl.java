...
import de.fraunhofer.fokus.oefit.particity.NoSuchAHSubscriptionException;
...
public class AHSubscriptionPersistenceImpl extends BasePersistenceImpl<AHSubscription>
    ...
    public void setAHCatEntrieses(long pk,
        ...
        try {
            ...
            FinderCacheUtil.clearCache(AHSubscriptionModelImpl.MAPPING_TABLE_PARTICITY_SUB_CITM_NAME);
        }
    }
