...
import de.fraunhofer.fokus.oefit.particity.model.AHCatEntriesModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link de.fraunhofer.fokus.oefit.particity.model.AHCatEntriesModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AHCatEntriesImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see AHCatEntriesImpl
 * @see de.fraunhofer.fokus.oefit.particity.model.AHCatEntries
 * @see de.fraunhofer.fokus.oefit.particity.model.AHCatEntriesModel
 * @generated
 */
public class AHCatEntriesModelImpl extends BaseModelImpl<AHCatEntries>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a a h cat entries model instance should use the {@link de.fraunhofer.fokus.oefit.particity.model.AHCatEntries} interface instead.
     */
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.de.fraunhofer.fokus.oefit.particity.model.AHCatEntries"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.de.fraunhofer.fokus.oefit.particity.model.AHCatEntries"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.de.fraunhofer.fokus.oefit.particity.model.AHCatEntries"),
            true);
    ...
    public static final String MAPPING_TABLE_PARTICITY_SUB_CITM_NAME = "PARTICITY_sub_citm";
    public static final Object[][] MAPPING_TABLE_PARTICITY_SUB_CITM_COLUMNS = {
            { "itemId", Types.BIGINT },
            { "subId", Types.BIGINT }
        };
    public static final String MAPPING_TABLE_PARTICITY_SUB_CITM_SQL_CREATE = "create table PARTICITY_sub_citm (itemId LONG not null,subId LONG not null,primary key (itemId, subId))";
    public static final boolean FINDER_CACHE_ENABLED_PARTICITY_SUB_CITM = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.PARTICITY_sub_citm"), true);
    public static final String MAPPING_TABLE_PARTICITY_OFFER_CITM_NAME = "PARTICITY_offer_citm";
    public static final Object[][] MAPPING_TABLE_PARTICITY_OFFER_CITM_COLUMNS = {
            { "itemId", Types.BIGINT },
            { "offerId", Types.BIGINT }
        };
    public static final String MAPPING_TABLE_PARTICITY_OFFER_CITM_SQL_CREATE = "create table PARTICITY_offer_citm (itemId LONG not null,offerId LONG not null,primary key (itemId, offerId))";
    public static final boolean FINDER_CACHE_ENABLED_PARTICITY_OFFER_CITM = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.PARTICITY_offer_citm"), true);
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.de.fraunhofer.fokus.oefit.particity.model.AHCatEntries"));
