<div class="columns-1-1-2-2-2-2-1 container-fluid" id="main-content" role="main">
  ...
  <div class="portlet-layout row">
    <div class="col-md-2 portlet-column portlet-column-first" id="column-5">
      $processor.processColumn("column-5", "portlet-column-content portlet-column-content-first")
    </div>

    <div class="col-md-9 col-md-offset-1 portlet-column portlet-column-last" id="column-6">
  ...
  <div class="portlet-layout row">
    <div class="col-md-9 portlet-column portlet-column-first" id="column-9">
      $processor.processColumn("column-9", "portlet-column-content portlet-column-content-first")
    </div>

    <div class="col-md-2 col-md-offset-1 portlet-column portlet-column-last" id="column-10">
