...
Currently, there are several sources for documentation
 ...
 - The original project announcement at the [Kompetenzzentrum Öffentliche IT](https://www.oeffentliche-it.de/mitmachboerse) (german only)

## Demo site
The demo site is currently hosted over [here](http://193.175.133.70), sponsered by the [Kompetenzzentrum Öffentliche IT](https://www.oeffentliche-it.de)  
