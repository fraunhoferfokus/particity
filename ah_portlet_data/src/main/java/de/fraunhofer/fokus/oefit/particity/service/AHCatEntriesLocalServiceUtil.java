 ...
 * {@link de.fraunhofer.fokus.oefit.particity.service.impl.AHCatEntriesLocalServiceImpl} and is the
 ...
 * @see de.fraunhofer.fokus.oefit.particity.service.base.AHCatEntriesLocalServiceBaseImpl
...
public class AHCatEntriesLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link de.fraunhofer.fokus.oefit.particity.service.impl.AHCatEntriesLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static de.fraunhofer.fokus.oefit.particity.model.AHCatEntries addAHCatEntries(
    ...
    */
    public static de.fraunhofer.fokus.oefit.particity.model.AHCatEntries createAHCatEntries(
        long itemId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.fraunhofer.fokus.oefit.particity.model.AHCatEntries deleteAHCatEntries(
        long itemId)
    ...
    */
    ...
    public static de.fraunhofer.fokus.oefit.particity.model.AHCatEntries fetchAHCatEntries(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.fraunhofer.fokus.oefit.particity.model.AHCatEntries getAHCatEntries(
        long itemId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.fraunhofer.fokus.oefit.particity.model.AHCatEntries updateAHCatEntries(
        de.fraunhofer.fokus.oefit.particity.model.AHCatEntries ahCatEntries)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHCatEntries> getAHSubscriptionAHCatEntrieses(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHCatEntries> getAHOfferAHCatEntrieses(
        long offerId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHCatEntries> getCategoryEntries(
        long catId) {
        return getService().getCategoryEntries(catId);
    }

    public static java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHCatEntries> getCategoryEntriesChildsSorted(
        long catId) {
        return getService().getCategoryEntriesChildsSorted(catId);
    }

    public static de.fraunhofer.fokus.oefit.particity.model.AHCatEntries getCategoryEntryById(
        long entryId) {
        return getService().getCategoryEntryById(entryId);
    }

    public static java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHCatEntries> getChildEntriesById(
        long entryId) {
        return getService().getChildEntriesById(entryId);
    }

    public static java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHCatEntries> getEntriesForCatId(
        long catId) {
