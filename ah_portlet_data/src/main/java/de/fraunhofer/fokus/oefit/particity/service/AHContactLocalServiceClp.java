...
public class AHContactLocalServiceClp implements AHContactLocalService {
    ...
    public de.fraunhofer.fokus.oefit.particity.model.AHContact addAHContact(
        ...
        return (de.fraunhofer.fokus.oefit.particity.model.AHContact) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHContact> getAHContacts(
        ...
        return (java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHContact>) ClpSerializer.translateOutput(returnObj);
    }
