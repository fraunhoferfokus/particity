...
public class AHRegionLocalServiceClp implements AHRegionLocalService {
    ...
    public de.fraunhofer.fokus.oefit.particity.model.AHRegion addAHRegion(
        ...
        return (de.fraunhofer.fokus.oefit.particity.model.AHRegion) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHRegion> getAHRegions(
        ...
        return (java.util.List<de.fraunhofer.fokus.oefit.particity.model.AHRegion>) ClpSerializer.translateOutput(returnObj);
    }
