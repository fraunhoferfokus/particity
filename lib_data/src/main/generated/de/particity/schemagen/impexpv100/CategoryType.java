 ...
 *         &lt;element name="entry" type="{http://github.com/fraunhoferfokus/particity/ImportExport}CategoryEntryType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CategoryType {
    ...
    protected List<CategoryEntryType> entry;
     ...
     * 
     */
    public List<CategoryEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<CategoryEntryType>();
        }
        return this.entry;
    }
